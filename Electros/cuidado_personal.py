...
url = 'https://www.hiperlibertad.com.ar/electrodomesticos/cuidado-personal-y-salud' + "?sc=" + branch + "&page="
...
with open('cuidado_personal.csv', 'w', encoding='utf-8', newline='') as file:
