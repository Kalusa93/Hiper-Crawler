...
url = 'https://www.hiperlibertad.com.ar/electrodomesticos/heladeras-y-freezers' + "?sc=" + branch + "&page="
...
with open('heladeras.csv', 'w', encoding='utf-8', newline='') as file:
