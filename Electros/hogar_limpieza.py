...
url = 'https://www.hiperlibertad.com.ar/electrodomesticos/hogar-y-limpieza' + "?sc=" + branch + "&page="
...
with open('hogar_limpieza.csv', 'w', encoding='utf-8', newline='') as file:
