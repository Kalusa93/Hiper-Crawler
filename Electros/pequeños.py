...
url = 'https://www.hiperlibertad.com.ar/electrodomesticos/pequenos-electrodomesticos' + "?sc=" + branch + "&page="
...
def get_product(link):
    ...
    category = 'Pequeños_electrodomésticos'
...
with open('pequeños.csv', 'w', encoding='utf-8', newline='') as file:
