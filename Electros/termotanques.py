...
url = 'https://www.hiperlibertad.com.ar/electrodomesticos/termotanques-y-calefones' + "?sc=" + branch + "&page="
...
with open('termotanques.csv', 'w', encoding='utf-8', newline='') as file:
