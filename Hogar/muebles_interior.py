...
url = 'https://www.hiperlibertad.com.ar/hogar/muebles-de-interior' + "?sc=" + branch + "&page="
...
with open('muebles_interior.csv', 'w', encoding='utf-8', newline='') as file:
